...
#. `Check for open issues or open a fresh issue to start a discussion <https://github.com/PalisadoesFoundation/pattoo-shared/issues>`_ around a feature idea or a bug. There is a `good first issue` tag for issues that should be ideal for people who are not very familiar with the codebase yet
...
#. `Fork the repository on GitHub <https://github.com/PalisadoesFoundation/pattoo-shared/issues>`_ in preparation for your changes
#. Clone your GitHub repository to your local machine
#. Add the original project as a remote repository `git remote add upstream https://github.com/PalisadoesFoundation/pattoo-shared`. Check everything is OK with `git remote -v`.
...
#. Make sure to add yourself to `CONTRIBUTORS.rst <https://github.com/PalisadoesFoundation/pattoo-shared/CONTRIBUTORS.rst>`_
